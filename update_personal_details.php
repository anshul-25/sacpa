...
if(isset($_POST["submit"]))
{
  ...
  $update_query = "UPDATE `student` SET `Title`=\"".$title."\", `PhoneNo`=".$phoneno.",`EmailIdPersonal`=\"".$emailid."\",`HouseNo`=\"".$house."\",`Streetno`=\"".$street."\",`City_id`=".$city.", `zipcode` =".$zipcode.",`Religion`=\"".$religion."\",`ReservationCategory`=\"".$reservation."\" WHERE `RegisterNo`=".$registerno;
...
<html>
<head>
	<title>Personal Update form</title>
	<meta charset="utf-8">
