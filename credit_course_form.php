...
<body>
  <div class="vertical-center ">
    <div class="container-fluid  text-dark m-0 p-3">
        ...
        <div class="form-group details">
          <div class="form-group">
            ...
            <div class="form-row">
             ...
             <div class="form-group col-md-4">
               <input type="text" class="form-control" name="inputCCName[]" id="inputCCName" placeholder="Credit Course Name" required>
             </div> 
             <div class="form-group col-md-4">
     ...
     <button type="button" class="btn btn-outline-primary">Add Credit Course +</button>
