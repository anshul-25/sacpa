        ...
        <form method="POST" action="#">
          <div class="form-group details">
            ...
            <div class="form-row">
             ...
             <div class="form-group col-md-3">
            <input placeholder="Date" type="text" class="form-control" onfocus="(this.type='date')" onblur="(this.type='text')" name="inputDate[]" id="inputDate" >
          </div>	
           </div>
           <div class="form-row">
